                                ...
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                            <h4>Activities</h4>
                                            <a href="{{ route('admin.activity.create') }}" class="btn btn-primary">Activity Create</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered text-center mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $activity->slug }}</td>
                                                <td><img src="{{ asset($activity->icon) }}" alt="slider-img" width="150px" height="150px" /></td>
                                                ...
                                                <td>
                                                    <a  class="btn btn-secondary" href="{{ route('admin.activity.edit', [$activity->id]) }}">Edit</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
